...
/* This header file describes the Register Map for the DijkstraNaiveID kernel */
...
#ifndef __DIJKSTRANAIVEID_REGISTER_MAP_REGS_H__
#define __DIJKSTRANAIVEID_REGISTER_MAP_REGS_H__
...
/* Byte Addresses */
#define DIJKSTRANAIVEID_REGISTER_MAP_STATUS_REG (0x0 + DIJKSTRANAIVEID_REGISTER_MAP_OFFSET)
#define DIJKSTRANAIVEID_REGISTER_MAP_START_REG (0x8 + DIJKSTRANAIVEID_REGISTER_MAP_OFFSET)
#define DIJKSTRANAIVEID_REGISTER_MAP_FINISHCOUNTER_REG (0x30 + DIJKSTRANAIVEID_REGISTER_MAP_OFFSET)
#define DIJKSTRANAIVEID_REGISTER_MAP_FINISHCOUNTER_REG (0x34 + DIJKSTRANAIVEID_REGISTER_MAP_OFFSET)
#define DIJKSTRANAIVEID_REGISTER_MAP_ARG_ARG_G_REG (0x80 + DIJKSTRANAIVEID_REGISTER_MAP_OFFSET)
#define DIJKSTRANAIVEID_REGISTER_MAP_ARG_ARG_DIST_REG (0x88 + DIJKSTRANAIVEID_REGISTER_MAP_OFFSET)
#define DIJKSTRANAIVEID_REGISTER_MAP_ARG_ARG_VISITED_REG (0x90 + DIJKSTRANAIVEID_REGISTER_MAP_OFFSET)

/* Argument Sizes (bytes) */
#define DIJKSTRANAIVEID_REGISTER_MAP_ARG_ARG_G_SIZE (8)
#define DIJKSTRANAIVEID_REGISTER_MAP_ARG_ARG_DIST_SIZE (8)
#define DIJKSTRANAIVEID_REGISTER_MAP_ARG_ARG_VISITED_SIZE (8)

/* Argument Masks */
#define DIJKSTRANAIVEID_REGISTER_MAP_ARG_ARG_G_MASK (0xffffffffffffffffULL)
#define DIJKSTRANAIVEID_REGISTER_MAP_ARG_ARG_DIST_MASK (0xffffffffffffffffULL)
#define DIJKSTRANAIVEID_REGISTER_MAP_ARG_ARG_VISITED_MASK (0xffffffffffffffffULL)

#endif /* __DIJKSTRANAIVEID_REGISTER_MAP_REGS_H__ */
