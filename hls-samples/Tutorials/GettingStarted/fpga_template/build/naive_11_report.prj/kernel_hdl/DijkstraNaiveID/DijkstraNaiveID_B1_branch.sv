...
// SystemVerilog created from DijkstraNaiveID_B1_branch
...
module DijkstraNaiveID_B1_branch (
    input wire [0:0] in_c0_exe1,
    input wire [0:0] in_c0_exe2,
    input wire [0:0] in_memdep_phi22_pop8,
    ...
    // out_memdep_phi22_pop8(GPOUT,11)
    assign out_memdep_phi22_pop8 = in_memdep_phi22_pop8;
