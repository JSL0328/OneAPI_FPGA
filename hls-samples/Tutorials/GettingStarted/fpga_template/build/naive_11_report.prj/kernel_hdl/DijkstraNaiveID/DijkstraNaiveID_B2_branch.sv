...
// SystemVerilog created from DijkstraNaiveID_B2_branch
...
module DijkstraNaiveID_B2_branch (
    input wire [63:0] in_c0_exe283,
    ...
    // out_c0_exe3931(GPOUT,11)
    assign out_c0_exe3931 = in_c0_exe3931;

    // out_c0_exe82(GPOUT,12)
    assign out_c0_exe82 = in_c0_exe82;

    // out_c0_exe93(GPOUT,13)
    assign out_c0_exe93 = in_c0_exe93;
