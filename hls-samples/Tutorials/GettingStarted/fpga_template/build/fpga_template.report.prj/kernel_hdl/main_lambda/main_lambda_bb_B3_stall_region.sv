...
// SystemVerilog created from bb_main_lambda_B3_stall_region
...
module main_lambda_bb_B3_stall_region (
    input wire [0:0] in_stall_in,
    output wire [0:0] out_stall_out,
    output wire [0:0] out_notcmp2030_pop192,
    ...
    // sync_out_45(GPOUT,7)@0
    assign out_stall_out = SE_stall_entry_backStall;

    // bubble_join_stall_entry(BITJOIN,11)
    assign bubble_join_stall_entry_q = in_notcmp2030_pop192;

    // bubble_select_stall_entry(BITSELECT,12)
    assign bubble_select_stall_entry_b = bubble_join_stall_entry_q[0:0];

    // sync_out_46(GPOUT,8)@0
    assign out_notcmp2030_pop192 = bubble_select_stall_entry_b;
