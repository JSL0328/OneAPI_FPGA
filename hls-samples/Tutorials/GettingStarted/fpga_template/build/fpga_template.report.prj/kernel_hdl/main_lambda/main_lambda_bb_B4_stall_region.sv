...
// SystemVerilog created from bb_main_lambda_B4_stall_region
...
module main_lambda_bb_B4_stall_region (
    ...
    // sync_out_47(GPOUT,7)@0
    assign out_stall_out = SE_stall_entry_backStall;

    // bubble_join_stall_entry(BITJOIN,11)
    assign bubble_join_stall_entry_q = {in_notcmp2030_pop193, in_notcmp1534_pop241};
    ...
    // sync_out_48(GPOUT,8)@0
    assign out_notcmp1534_pop241 = bubble_select_stall_entry_b;
    assign out_notcmp2030_pop193 = bubble_select_stall_entry_c;
