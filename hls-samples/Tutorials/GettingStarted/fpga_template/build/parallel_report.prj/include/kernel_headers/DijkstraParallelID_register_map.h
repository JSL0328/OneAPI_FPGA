...
/* This header file describes the Register Map for the DijkstraParallelID kernel */
...
#ifndef __DIJKSTRAPARALLELID_REGISTER_MAP_REGS_H__
#define __DIJKSTRAPARALLELID_REGISTER_MAP_REGS_H__
...
---------|--------|--------------|-------------------------------------|-------------------------------
    0x80 |      W |  reg16[63:0] |                         arg_g[63:0] |                              
---------|--------|--------------|-------------------------------------|-------------------------------
    0x88 |      W |  reg17[63:0] |                      arg_dist[63:0] |                              
---------|--------|--------------|-------------------------------------|-------------------------------
    0x90 |      W |  reg18[63:0] |                   arg_visited[63:0] |                              
...
/* Byte Addresses */
#define DIJKSTRAPARALLELID_REGISTER_MAP_STATUS_REG (0x0 + DIJKSTRAPARALLELID_REGISTER_MAP_OFFSET)
#define DIJKSTRAPARALLELID_REGISTER_MAP_START_REG (0x8 + DIJKSTRAPARALLELID_REGISTER_MAP_OFFSET)
#define DIJKSTRAPARALLELID_REGISTER_MAP_FINISHCOUNTER_REG (0x30 + DIJKSTRAPARALLELID_REGISTER_MAP_OFFSET)
#define DIJKSTRAPARALLELID_REGISTER_MAP_FINISHCOUNTER_REG (0x34 + DIJKSTRAPARALLELID_REGISTER_MAP_OFFSET)
#define DIJKSTRAPARALLELID_REGISTER_MAP_ARG_ARG_G_REG (0x80 + DIJKSTRAPARALLELID_REGISTER_MAP_OFFSET)
#define DIJKSTRAPARALLELID_REGISTER_MAP_ARG_ARG_DIST_REG (0x88 + DIJKSTRAPARALLELID_REGISTER_MAP_OFFSET)
#define DIJKSTRAPARALLELID_REGISTER_MAP_ARG_ARG_VISITED_REG (0x90 + DIJKSTRAPARALLELID_REGISTER_MAP_OFFSET)

/* Argument Sizes (bytes) */
#define DIJKSTRAPARALLELID_REGISTER_MAP_ARG_ARG_G_SIZE (8)
#define DIJKSTRAPARALLELID_REGISTER_MAP_ARG_ARG_DIST_SIZE (8)
#define DIJKSTRAPARALLELID_REGISTER_MAP_ARG_ARG_VISITED_SIZE (8)

/* Argument Masks */
#define DIJKSTRAPARALLELID_REGISTER_MAP_ARG_ARG_G_MASK (0xffffffffffffffffULL)
#define DIJKSTRAPARALLELID_REGISTER_MAP_ARG_ARG_DIST_MASK (0xffffffffffffffffULL)
#define DIJKSTRAPARALLELID_REGISTER_MAP_ARG_ARG_VISITED_MASK (0xffffffffffffffffULL)

#endif /* __DIJKSTRAPARALLELID_REGISTER_MAP_REGS_H__ */
