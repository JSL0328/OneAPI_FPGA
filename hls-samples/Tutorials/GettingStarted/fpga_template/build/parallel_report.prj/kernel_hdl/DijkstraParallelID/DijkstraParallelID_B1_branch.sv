...
// SystemVerilog created from DijkstraParallelID_B1_branch
...
module DijkstraParallelID_B1_branch (
    input wire [0:0] in_c0_exe1,
    input wire [0:0] in_c0_exe2,
    input wire [0:0] in_memdep_phi_pop5,
    ...
    // out_memdep_phi_pop5(GPOUT,10)
    assign out_memdep_phi_pop5 = in_memdep_phi_pop5;

    // stall_out(LOGICAL,2)
    assign stall_out_q = in_valid_in & in_stall_in_0;

    // out_stall_out(GPOUT,11)
