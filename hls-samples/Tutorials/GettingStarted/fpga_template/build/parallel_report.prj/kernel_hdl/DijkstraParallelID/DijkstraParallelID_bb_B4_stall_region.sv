...
// SystemVerilog created from bb_DijkstraParallelID_B4_stall_region
...
module DijkstraParallelID_bb_B4_stall_region (
    ...
    // sync_out_753(GPOUT,7)@0
    assign out_stall_out = SE_stall_entry_backStall;

    // sync_out_754(GPOUT,8)@0
