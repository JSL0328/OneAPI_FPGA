...
/* This header file describes the Register Map for the DijkstraOptimisedID kernel */
...
#ifndef __DIJKSTRAOPTIMISEDID_REGISTER_MAP_REGS_H__
#define __DIJKSTRAOPTIMISEDID_REGISTER_MAP_REGS_H__
...
---------|--------|--------------|-------------------------------------|-------------------------------
    0x80 |      W |  reg16[63:0] |                  arg_out_dist[63:0] |                              
---------|--------|--------------|-------------------------------------|-------------------------------
    0x88 |      W |  reg17[63:0] |                      arg_in_g[63:0] |                              
...
/* Byte Addresses */
#define DIJKSTRAOPTIMISEDID_REGISTER_MAP_STATUS_REG (0x0 + DIJKSTRAOPTIMISEDID_REGISTER_MAP_OFFSET)
#define DIJKSTRAOPTIMISEDID_REGISTER_MAP_START_REG (0x8 + DIJKSTRAOPTIMISEDID_REGISTER_MAP_OFFSET)
#define DIJKSTRAOPTIMISEDID_REGISTER_MAP_FINISHCOUNTER_REG (0x30 + DIJKSTRAOPTIMISEDID_REGISTER_MAP_OFFSET)
#define DIJKSTRAOPTIMISEDID_REGISTER_MAP_FINISHCOUNTER_REG (0x34 + DIJKSTRAOPTIMISEDID_REGISTER_MAP_OFFSET)
#define DIJKSTRAOPTIMISEDID_REGISTER_MAP_ARG_ARG_OUT_DIST_REG (0x80 + DIJKSTRAOPTIMISEDID_REGISTER_MAP_OFFSET)
#define DIJKSTRAOPTIMISEDID_REGISTER_MAP_ARG_ARG_IN_G_REG (0x88 + DIJKSTRAOPTIMISEDID_REGISTER_MAP_OFFSET)

/* Argument Sizes (bytes) */
#define DIJKSTRAOPTIMISEDID_REGISTER_MAP_ARG_ARG_OUT_DIST_SIZE (8)
#define DIJKSTRAOPTIMISEDID_REGISTER_MAP_ARG_ARG_IN_G_SIZE (8)

/* Argument Masks */
#define DIJKSTRAOPTIMISEDID_REGISTER_MAP_ARG_ARG_OUT_DIST_MASK (0xffffffffffffffffULL)
#define DIJKSTRAOPTIMISEDID_REGISTER_MAP_ARG_ARG_IN_G_MASK (0xffffffffffffffffULL)

#endif /* __DIJKSTRAOPTIMISEDID_REGISTER_MAP_REGS_H__ */
