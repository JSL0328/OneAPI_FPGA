...
add_instance fpga_template_report_sys fpga_template_report_sys

add_connection clk_1x.out_clk fpga_template_report_sys.clock_reset
add_connection reset.out_reset fpga_template_report_sys.clock_reset_reset

## Connect global memory hosts to memory interfaces
add_interface mem0_rw avalon end
set_interface_property mem0_rw EXPORT_OF fpga_template_report_sys.avm_mem_gmem0_0_port_0_0_rw
...
add_connection kernel_irq.receiver_irq fpga_template_report_sys.kernel_irq
...
add_connection kernel_cra.m0 fpga_template_report_sys.csr_ring_root_avs
set_connection_parameter_value kernel_cra.m0/fpga_template_report_sys.csr_ring_root_avs baseAddress "0x0"
