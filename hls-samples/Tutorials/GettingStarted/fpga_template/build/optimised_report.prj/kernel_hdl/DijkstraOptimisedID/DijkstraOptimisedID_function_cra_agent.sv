...
// SystemVerilog created from DijkstraOptimisedID_function_cra_agent
...
module DijkstraOptimisedID_function_cra_agent (
    ...
    reg [127:0] pipe_reg0_kernel_arguments_q;
    reg [0:0] pipe_reg0_kernel_start_q;
    reg [127:0] pipe_reg1_kernel_arguments_q;
    ...
    // write_selector_start_status(MUX,120)
    ...
    // not_last_finish_state(LOGICAL,73)
    ...
    // is_finish_counter_addr(LOGICAL,61)
    ...
    // status_self_update(BITJOIN,116)
    ...
    // avs_cra_readdatavalid(GPOUT,155)
    ...
    // pipe_reg1_kernel_arguments(REG,80)
    always_ff @ (posedge clock)
    begin
        if (0)
        begin
